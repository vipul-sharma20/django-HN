...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'contacts_userprofile', (
            ...
            ('profile_picture', self.gf('django.db.models.fields.files.ImageField')(default='/home/vipul/Photo13892.jpg', max_length=100, blank=True)),
        ))
    ...
    models = {
        ...
        u'contacts.userprofile': {
            ...
            'profile_picture': ('django.db.models.fields.files.ImageField', [], {'default': "'/home/vipul/Photo13892.jpg'", 'max_length': '100', 'blank': 'True'}),
